  ...
  return (
    <div id="education" className="w-full flex flex-col justify-center items-center">
      <div className="w-full max-w-[1500px]">
        <div
          className="font-bold flex flex-col items-center mt-10 text-indigo-600 dark:text-indigo-500 capitalize text-5xl  "
          data-aos="zoom-in"
        ...
        <div className="flex flex-row w-[80%]  max-[1200px]:p-2 max-[1200px]:flex-col max-[1200px]:items-center  mt-6 p-4 justify-between mx-auto ">
          ...
          >
            <div className="flex gap-x-3 mt-[100px] max-[1200px]:mt-0 justify-center max-[500px]:flex-col max-[500px]:justify-between max-[500px]:items-between max-[500px]:items-center max-[500px]:gap-y-5">
              <img
                src={ManitLogo}
                className="w-[140px] h-[140px] dark:filter dark:invert  dark:brightness-[0.85] "
                style={{
                  filter:
              ...
              <p className="bg-clip-text text-center max-[500px]:my-0 my-auto text-transparent bg-gradient-to-r max-sm:text-[17px] from-amber-500 via-orange-600 to-yellow-500 dark:from-[#ff6600] dark:to-slate-100 font-semibold text-2xl py-4 max-w-[300px] max-h-[200px] tracking-wider ">
                Maulana Azad National Institute Of Technology Bhopal
              </p>
            </div>

            <div className="flex flex-col gap-5 mt-7 max-[500px]:mt-5 text-left ml-4">
